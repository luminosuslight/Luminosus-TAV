...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{img/polyspace_code_prover}
	\caption[Polyspace Code Prover Results]{Polyspace Code Prover Results}
	\label{fig:polyspace_code_prover}
\end{figure}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{img/polyspace_invariants}
	\caption[Polyspace Invariants]{Invariants found by Polyspace}
	\label{fig:polyspace_invariants}
\end{figure}
