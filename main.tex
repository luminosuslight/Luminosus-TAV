...
% TODO: mehr kontext für den code, wieso genau crasht die app? was ist ein cue-objekt?
% TODO: eventuell alle if conditions zeigen
\bigskip
\begin{lstlisting}[language=C++,
							numbers=left,
							firstnumber=78,
...
\begin{itemize}
	...
	% TODO: epected output when test would work?
...
% TODO: warum sind keine tests vorhanden? => Manuelles und user testing wurde eingesetzt!
...
\begin{table}[h]
	...
	\begin{tabular}{r|ccc|c|l|c|c}
		   & $a$ & $b$ & $c$ & $a \lor (!b \land c)$ & $p_a$ & $p_b$ & $p_c$ \\ \hline
		1 & T & T & T & T & *\quad\quad  &   &  \\
		2 & T & T & F & T & \quad*\quad  &   &  \\
		3 & T & F & T & T & \quad\quad*  &   &  \\
		4 & T & F & F & T &        &   &  \\
...
-> with 4 tests (1, 5, 7, 8) CACC, clause and predicate coverage is reached

 clause coverage is already reached with 1, 8
 
 predicate coverage is already reached with 1, 8 (or 1, 5 and so on)
...
% TODO: Ist dieses Kapitel gefragt?
...
% TODO: anderes tool? Wieso geht das nicht mit den verwendeten Tools?
...
% TODO: ausformulieren? => Motivation: Tools bieten keine Coverage! Darum analysieren wir manuell die coverage anhand des Graphen

% TODO: code neben dem Graphen darstellen?
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{img/cfg_rescale_to}
	\caption[Control Flow Graph rescaleTo()]{Control Flow Graph of the rescaleTo() Method}
...
% TODO: Evaluierung fehlt! Statische Analyse und Testing fehlt! Kapitelreihenfolge evtl überdenken!
